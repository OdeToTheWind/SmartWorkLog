  ...
  return (
    <div className="space-y-6 max-w-2xl" data-testid="leaderboard-page">
      ...
      <div className="bg-white border border-slate-200 rounded-lg divide-y">
        {rows.length === 0 && <div className="p-6 text-sm text-slate-500 text-center">No completed tasks this week yet.</div>}
        {rows.map((r, i) => (
          <div key={r.id} className="p-4 flex items-center gap-4" data-testid={`leaderboard-row-${i}`}>
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-slate-500">{ROLE_LABEL[r.role]}</div>
            </div>
