    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm">Sign in to your account or create a new company.</p>
        </div>

        <Tabs defaultValue="login" className="bg-white border border-slate-200 rounded-xl p-6">
